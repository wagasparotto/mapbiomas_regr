...
---
# instalação/load dos pacotes (divido em 'essenciais' e outras que tem incompatibilidades)
```{r}
...
libraries <- c("plotly","tidyverse","reshape2","knitr","kableExtra",
             "nlme","lmtest","fastDummies","msm","lmeInfo","jtools", "shiny", "tidyr", "data.table", "plyr", "gridGraphics")
...
# gridGraphics --> para poder capturar o plot do corrplot (matriz de correlação)
...
# bibliotecas pesadas ou que acabam gerando erros em outras
## problema do choose.file está em alguma dessas
```{r}
## Install and load libraries (every time when opening the project!)

#Pacotes utilizados (até jtools é cópia do script da aula 2 de 'Multinível' (Fávero):
libraries <- c("sf","tmap","rgdal","rgeos", "dtw", "dtwclust", "factoextra", "ggdendro", "dendextend", "NbClust", "ggrepel", "directlabels", "geomtextpath", "tcltk", "svDialogs","scales", "Hmisc","corrplot", "heatmaply", "vegan", "cluster", "gg.layers")
...
## Pacotes da Aula 04 de regressão linear - (para utilizar o Exmplo 8)com esses pacotes não tem bug no choose.file)
```{r}

## Install and load libraries (every time when opening the project!)

#Pacotes utilizados (até jtools é cópia do script da aula 2 de 'Multinível' (Fávero):
libraries <- c("plotly","tidyverse","ggrepel","fastDummies","knitr","kableExtra",
             "splines","reshape2","PerformanceAnalytics","metan","correlation",
             "see","ggraph","nortest","rgl","car","olsrr","jtools","ggstance",
             "magick","cowplot","beepr","Rcpp", "gridGraphics")
